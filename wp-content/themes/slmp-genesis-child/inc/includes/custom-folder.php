...
class create_folder {
	public function __construct() {
		...
		$this->create_dynamic_backup_custom_folder();
	}
	...
	public function create_dynamic_backup_custom_folder() {
		if ( !is_dir( SLMP_THEME_UPLOAD_DIR . '/slmp-dynamic-gen/dynamic-custom-backup' ) ) {
		    mkdir( SLMP_THEME_UPLOAD_DIR . '/slmp-dynamic-gen/dynamic-custom-backup' , 0777, true );
		}
	}
